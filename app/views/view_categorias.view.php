  ...
  <div class="container" style="margin-bottom: 15px;">
    ...
    <div class="card-deck" style="margin-top: 15px;">
          ...
          <div class="card card-bckg" style="width: 18rem;">
            ...
            <div class="card-body titulo5">
              ...
              <div style="text-align: right;">
                ...
                <a href="editar_categorias.html"><button type="button" class="btn btn-outline-warning" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="fas fa-pen"></i></button></a>
      ...
      <div class="buttonSubmit">
        <a href="criar_categorias.html"><button type="button" class="btn btn-addProduct mt-1"><b>Adicionar Categoria </b></button></a>
      </div>
    </div>
