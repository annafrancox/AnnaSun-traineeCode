        ...
        <?php foreach ($visual as $view) : ?>
            <form method = "POST" action = "editarUsuario">
                <div  class = " form-group ">
                    ...
                    <input  type = " email " value =" <?= $view->nome?>" class = " form-control digita_adm " id = " exampleFormControlInput1 ">
                </div>
                <formulário>
                    <div  class = " form-group ">
                        <label label  for = " exampleFormControlInput1 " > Email </label>
                        <input  type = " email " value =" <?= $view->email?>"class = " form-control digita_adm" id = " exampleFormControlInput1 "">
                    </div>
                    <div  class = " form-group ">
                        <label label  for = " exampleFormControlInput1 " > Senha </label>
                        <input  type = " email " value =" <?= $view->senha?>"class = " form-control digita_adm" id = " exampleFormControlInput1 ">
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlFile1">Adicionar Foto</label>
                      <input type="file" value =" <?= $view->foto?>"class="form-control-file" id="exampleFormControlFile1">
                    </div>
