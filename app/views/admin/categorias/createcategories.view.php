...
<head>
    <meta charset="UTF-8">
    <title>Anna Sun Administração | Adicionar Categoria</title>
    ...
    <div class=" container pt-5 formBorder">
        ...
        <form action="/categorias/create" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="categoryName" class="form-control" id="exampleFormControlInput1" placeholder="Nome da categoria">
            </div>
